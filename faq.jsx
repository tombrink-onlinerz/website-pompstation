...
{/* Intro */}
  <section style={{ background: "#F5EFE6", padding: "clamp(46px, 8vw, 96px) 0 0" }}>
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)" }}>
      <p style={{ margin: "0", fontFamily: "'Instrument Serif',Georgia,serif", fontSize: "clamp(21px, 4.2vw, 32px)", lineHeight: "1.35", color: "#2A2A2A" }}>Bar Restaurant Pompstation is gevestigd in een voormalig waterpompstation uit 1912 aan de Zeeburgerdijk in Amsterdam-Oost. Wij serveren premium gegrilde steaks, lokale vis en vegetarische gerechten — altijd vers bereid op ons houtskoolvuur.</p>
  ...
  {/* Eten & drinken */}
  <section style={{ background: "#F5EFE6", padding: "clamp(46px, 8vw, 96px) 0 clamp(34px, 6.5vw, 64px)" }}>
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)", display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(34px, 6.5vw, 64px)", alignItems: "start" }}>
      ...
      <h2 style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#2A2A2A", fontSize: "clamp(38px, 9vw, 64px)", lineHeight: "0.9", margin: "0 0 40px" }}>Aan tafel</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(20px, 5vw, 40px)" }}>
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Is Pompstation geschikt voor à la carte dineren?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Wat voor keuken serveert Pompstation Amsterdam?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Zijn er vegetarische opties op het menu?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Kan ik bij Pompstation ook alleen komen voor cocktails en live muziek?</h3>
  ...
  <section style={{ background: "#F5EFE6", padding: "clamp(34px, 6.5vw, 64px) 0 clamp(46px, 8vw, 96px)" }}>
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)", display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(34px, 6.5vw, 64px)", alignItems: "start" }}>
      ...
      <h2 style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#2A2A2A", fontSize: "clamp(38px, 9vw, 64px)", lineHeight: "0.9", margin: "0 0 40px" }}>De avond zelf</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(20px, 5vw, 40px)" }}>
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Is er live muziek bij Pompstation?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Heeft Pompstation een terras?</h3>
  ...
  <section style={{ background: "#5C1A1B", color: "#F5EFE6", padding: "clamp(46px, 8vw, 96px) 0" }}>
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)", display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(34px, 6.5vw, 64px)", alignItems: "start" }}>
      ...
      <h2 style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#F5EFE6", fontSize: "clamp(38px, 9vw, 64px)", lineHeight: "0.9", margin: "0 0 40px" }}>Met een gezelschap</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(20px, 5vw, 40px)" }}>
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#F5EFE6", margin: "0 0 12px", lineHeight: "1.2" }}>Is Pompstation geschikt voor een groep of bedrijfsdiner?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#F5EFE6", margin: "0 0 12px", lineHeight: "1.2" }}>Kan ik Pompstation afhuren?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#F5EFE6", margin: "0 0 12px", lineHeight: "1.2" }}>Kan een groep per bus of per boot aankomen?</h3>
  ...
  <section style={{ background: "#F5EFE6", padding: "clamp(46px, 8vw, 96px) 0 0" }}>
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)", display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(34px, 6.5vw, 64px)", alignItems: "start" }}>
      ...
      <h2 style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#2A2A2A", fontSize: "clamp(38px, 9vw, 64px)", lineHeight: "0.9", margin: "0 0 40px" }}>Voor u komt</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(20px, 5vw, 40px)" }}>
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Hoe kom ik bij Pompstation Amsterdam?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Waar kan ik parkeren bij Pompstation?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Kan ik online reserveren bij Pompstation?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Wat zijn de openingstijden van Pompstation Amsterdam?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Is Pompstation rolstoeltoegankelijk?</h3>
        ...
        <div>
          <h3 style={{ fontFamily: "'Instrument Serif',Georgia,serif", fontWeight: "400", fontSize: "clamp(21px, 4.2vw, 30px)", color: "#5C1A1B", margin: "0 0 12px", lineHeight: "1.2" }}>Mag ik mijn hond meenemen?</h3>
  ...
  {/* SEO tekst */}
  <section style={{ background: "#EFE7D9", padding: "clamp(46px, 8vw, 96px) 0", marginTop: "96px", borderTop: "1px solid rgba(42,42,42,0.1)" }}>
    <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)" }}>
      <h2 style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#2A2A2A", fontSize: "clamp(25px, 5.2vw, 40px)", lineHeight: "0.95", margin: "0 0 8px" }}>Bereikbaarheid Pompstation Amsterdam</h2>
  ...
  <section style={{ background: "#F5EFE6", padding: "clamp(46px, 8vw, 96px) 0" }}>
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
        <Hov as="a" href="https://www.pompstation.nu/" target="_blank" rel="noopener" style={{ display: "block", background: "#EFE7D9", border: "1px solid rgba(42,42,42,0.15)", padding: "clamp(20px, 5vw, 40px)", transition: "border-color 0.2s ease" }}  styleHover={{ borderColor: "#5C1A1B" }} >
          ...
          <div style={{ fontFamily: "'Big Shoulders Display',Impact,sans-serif", fontWeight: "800", textTransform: "uppercase", color: "#2A2A2A", fontSize: "clamp(30px, 6.5vw, 48px)", lineHeight: "0.9" }}>Reserveer een tafel</div>
