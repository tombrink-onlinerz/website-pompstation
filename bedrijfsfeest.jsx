...
function App() {
  return (
    <div className="font-sans text-anthracite">
      ...
      <PageHero
        kicker="Groepen & afhuren · Bedrijfsfeest"
        title="Het"
        titleAccent="bedrijfsfeest"
        lead="Van een informele borrel tot een gala voor het hele bedrijf. Pompstation is de locatie die iedereen bijblijft."
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-5">
              {[
                ...
                ["Formaat","Borrel, diner of walking dinner"],
                ["Ruimte","Vide, exclusief of terras"],
                ["Muziek","Podium & eigen geluidsinstallatie"],
                ["Eindtijd","Tot 03:00 in het weekend"],
                ["Event manager","Vaste begeleiding"],
      ...
      <section className="bg-bordeaux text-cream py-16 md:py-20">
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            <h2 className="h-display text-cream text-4xl md:text-6xl">Bedrijfsfeest plannen?</h2>
