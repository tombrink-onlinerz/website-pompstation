...
function App() {
  return (
    <div className="font-sans text-anthracite">
      ...
      <PageHero
        kicker="Ruimtes · Volledig exclusief"
        title={t("Uw avond,","Your evening,")}
        titleAccent={t("onze locatie","our venue")}
        lead="De gehele locatie voor uw eigen avond — bruiloften, galadiners, productlanceringen. Voor tot 360 gasten."
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 grid md:grid-cols-12 gap-12">
          <div className="md:col-span-4">
            ...
            <ul className="space-y-5">
              {[["Capaciteit","tot 360 gasten"],["Inclusief","Zaal, vide & terras"],["Catering","Volledig verzorgd"],["A/V","Professioneel systeem"],["Bar","Meerdere bars mogelijk"],["Ervaring","15+ jaar evenementen"]].map(([k,v]) => <DetailRow key={k} k={k} v={v} />)}
            </ul>
          ...
          <div className="md:col-span-8">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="overflow-hidden" style={{height:'260px'}}>
                <Photo src="images/bride.jpg" alt="Bruiloft bij Pompstation" className="w-full h-full" position="center 25%" />
              </div>
              <div className="overflow-hidden" style={{height:'260px'}}>
      ...
      <section className="bg-bordeaux text-cream py-16 md:py-20">
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            <h2 className="h-display text-cream text-4xl md:text-6xl">Uw evenement plannen?</h2>
            <p className="mt-3 text-cream/75 text-lg">Ons eventteam helpt u graag verder.</p>
          </div>
